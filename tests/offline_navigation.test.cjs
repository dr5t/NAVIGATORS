...
function engineFixture() {
    ...
    for (const file of ['engine/matrix.js', 'engine/ekf.js', 'engine/map_matcher.js', 'engine/alignment.js', 'device_profiler.js', 'engine/preprocessing.js', 'offline_engine.js']) {
